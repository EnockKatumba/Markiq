  ...
  return (
    <div style={{ background: '#fff', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section className="hero-section">
        ...
        <div className="particles">
          {[
            ...
            { s: 4, c: '#7F77DD', l: '68%', t: '70%', d: '5.5s', dl: '0.5s' },
            { s: 5, c: '#3C3489', l: '82%', t: '35%', d: '6.5s', dl: '1.5s' },
            { s: 3, c: '#CECBF6', l: '35%', t: '80%', d: '4.5s', dl: '3s' },
            { s: 5, c: '#534AB7', l: '90%', t: '55%', d: '7s', dl: '0.8s' },
          ].map((p, i) => (
            <div key={i} className="particle" style={{ width: p.s, height: p.s, background: p.c, left: p.l, top: p.t, animationDuration: p.d, animationDelay: p.dl }} />
          ))}
        </div>
        ...
        <div className="hero-inner">
          <div className="hero-text">
            <div className="live-badge">
              ...
              Live — 1,247 scripts marked today
            </div>
            <h1 className="hero-h1">
              The marking workmate<br />
              that gives your<br />
              <span className="typewriter-wrap"><span className="typewriter">time back</span></span>
            </h1>
            <p className="hero-sub">Every lecturer deserves an assistant. MarkIQ reads your marking scheme, grades every student, and hands you the results. You just review.</p>
            <div className="hero-ctas">
              <button className="cta-main" onClick={() => navigate('/signup')}>Start marking free →</button>
              <button className="cta-sec" onClick={() => document.getElementById('how').scrollIntoView({ behavior: 'smooth' })}>See how it works</button>
            </div>
            <p className="hero-note">No credit card. Setup in 2 minutes. Cancel anytime.</p>
            <div className="proof-pills">
              {['95% less time marking', '300+ scripts per hour', '100% lecturer controlled'].map(p => (
                <div key={p} className="proof-pill"><span className="proof-check">✓</span> {p}</div>
              ))}
            </div>
          </div>

          {/* PRODUCT SCREENSHOT */}
          <div className="screenshot-section" style={{ position: 'relative' }}>
            <div className="float-card" style={{ top: -18, right: 60, animationDelay: '0s' }}>
              <div className="float-card-icon">⚡</div>
              <div><div className="float-card-title">AI marking complete</div><div className="float-card-sub">32 students · 4 minutes</div></div>
            </div>
            <div className="float-card float-card-dark" style={{ bottom: 40, left: -20, animationDelay: '1.5s' }}>
              <div className="float-card-icon">🎉</div>
              <div><div className="float-card-title">Results released!</div><div className="float-card-sub">Students can now view scores</div></div>
            </div>
            ...
            <div className="browser-wrap">
              <div className="browser-bar">
                <div className="b-dots">
                  ...
                  <div className="b-dot" style={{ background: '#28C840' }}></div>
                </div>
                <div className="b-url">markiq.app/results/eng201</div>
              </div>
              <div className="browser-body">
                <div className="shimmer-line"></div>
                <div className="product-ui">
                  <div className="p-sidebar">
                    <div className="p-sidebar-logo">Mark<span>IQ</span></div>
                    <div className="p-nav">
                      <div className="p-nav-item"><span>🏠</span> Dashboard</div>
                      <div className="p-nav-item on"><span>📋</span> Courseworks</div>
                      <div className="p-nav-item"><span>👥</span> Students</div>
                      <div className="p-nav-item"><span>📊</span> Analytics</div>
                    </div>
                    <div className="p-section-label">Recent</div>
                    <div className="p-cw-item on">ENG 201 Mid-sem <span className="p-cw-badge">32</span></div>
                    <div className="p-cw-item">BUS 301 Final <span className="p-cw-badge">48</span></div>
                    <div className="p-cw-item">LAW 201 CAT <span className="p-cw-badge">24</span></div>
                  </div>
                  <div className="p-main">
                    <div className="p-main-header">
                      <div>
                        <div className="p-main-title">ENG 201 — Mid-semester coursework</div>
                        <div className="p-main-sub">32 students · 80 marks total · marked 4 mins ago</div>
                      </div>
                      <div className="p-ai-badge">⚡ AI marked</div>
                    </div>
                    <div className="p-stats">
                      <div className="p-stat"><div className="p-stat-num">32</div><div className="p-stat-label">Students marked</div></div>
                      <div className="p-stat"><div className="p-stat-num">58/80</div><div className="p-stat-label">Class average</div></div>
                      <div className="p-stat"><div className="p-stat-num">72</div><div className="p-stat-label">Highest score</div></div>
                    </div>
                    <div className="p-table">
                      <div className="p-table-head"><span>Student</span><span>Score</span></div>
                      {[
                        { name: 'Aisha Nakamura', meta: 'Q1: 18/20 · Q2: 14/15 · Q3: 40/45', score: '72/80', bg: '#E1F5EE', color: '#0F6E56', sel: true },
                        { name: 'Brian Okello', meta: 'Q1: 14/20 · Q2: 10/15 · Q3: 32/45', score: '56/80', bg: '#EEEDFE', color: '#534AB7', sel: false },
                        { name: 'Claudette Mugisha', meta: 'Q1: 12/20 · Q2: 8/15 · Q3: 24/45', score: '44/80', bg: '#EEEDFE', color: '#534AB7', sel: false },
                        { name: 'David Ssempa', meta: 'Q1: 8/20 · Q2: 5/15 · Q3: 15/45', score: '28/80', bg: '#FAECE7', color: '#993C1D', sel: false },
                        { name: 'Eva Namutebi', meta: 'Q1: 16/20 · Q2: 12/15 · Q3: 36/45', score: '64/80', bg: '#E1F5EE', color: '#0F6E56', sel: false },
                      ].map(s => (
                        <div key={s.name} className={`p-row ${s.sel ? 'sel' : ''}`}>
                          <div><div className="p-row-name">{s.name}</div><div className="p-row-meta">{s.meta}</div></div>
                          <span className="p-score" style={{ background: s.bg, color: s.color }}>{s.score}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  <div className="p-right">
                    <div className="p-right-top">
                      <div><div className="p-right-name">Aisha Nakamura</div><div className="p-right-sub">Selected student</div></div>
                      <div className="p-total">72/80</div>
                    </div>
                    {[
                      { label: 'Q1 — Definition', reason: 'Correct definition with strong examples', val: 18, max: 20 },
                      { label: 'Q2 — Analysis', reason: 'Good analysis, minor points missed', val: 14, max: 15 },
                      { label: 'Q3 — Essay', reason: 'Well structured with a strong conclusion', val: 40, max: 45 },
                    ].map(q => (
                      <div key={q.label} className="p-q">
                        <div style={{ flex: 1 }}><div className="p-q-label">{q.label}</div><div className="p-q-reason">{q.reason}</div></div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                          <input className="p-score-input" defaultValue={q.val} type="number" readOnly />
                          <span style={{ fontSize: 9, color: '#aaa' }}>/ {q.max}</span>
                        </div>
                      </div>
                    ))}
                    <div className="p-fb">
                      <div className="p-fb-label">AI FEEDBACK</div>
                      <div className="p-fb-text">Excellent work. Strong grasp of concepts. Minor gaps in Q2 but compensated in the essay.</div>
                    </div>
                    <button className="p-release-btn">📢 Release to students</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="stats-band">
        {[{ n: '95%', l: 'Less time marking' }, { n: '300+', l: 'Scripts per hour' }, { n: '100%', l: 'Lecturer in control' }].map(s => (
          <div key={s.l} className="s-item"><div className="s-num">{s.n}</div><div className="s-label">{s.l}</div></div>
        ))}
      </div>

      {/* SOCIAL PROOF */}
      <div className="proof-section" id="proof">
        <div className="proof-inner">
          <div className="proof-label">What lecturers are saying</div>
          <div className="testimonial">
            <div className="t-stars">★★★★★</div>
            <div className="t-text">"I used to spend entire weekends marking 200 scripts. MarkIQ marked them in under 5 minutes. I reviewed, adjusted a few scores, and was done by Friday evening. This is exactly what every lecturer in Africa needs."</div>
            <div className="t-author">
              <div className="t-avatar">👩‍🏫</div>
              <div>
                <div className="t-name">Dr. Sarah Nakato</div>
                <div className="t-role">Senior Lecturer, Department of Engineering · Makerere University</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="how-section" id="how">
        ...
        <div className="steps">
          {[
            { n: '01', icon: '📋', title: 'Upload your marking scheme', desc: 'Paste or type your rubric. MarkIQ understands what correct answers look like — flexible enough to reward good thinking even when worded differently.' },
            { n: '02', icon: '📄', title: 'Upload student answers', desc: 'Paste one student or bulk upload many at once. Upload files directly too. MarkIQ marks every answer instantly with full reasoning.' },
            { n: '03', icon: '✅', title: 'Review, override, release', desc: 'See scores per student per question. Override anything you disagree with. Release results to students when you are ready.' },
          ].map(s => (
      ...
      <div className="pricing-section">
        <div className="pricing-inner" id="pricing">
          <div className="section-eyebrow">Pricing</div>
          <div className="section-title">Start free. Scale when ready.</div>
          <div className="plans">
            {[
              { tier: 'Free', price: 'UGX 0', desc: 'Try it with no commitment.', feats: ['1 coursework per month', 'Up to 30 students', 'Basic score output'], cta: 'Get started free', featured: false },
              { tier: 'Pro', price: 'UGX 30,000', desc: 'For lecturers with full classes.', feats: ['Unlimited courseworks', 'Up to 100 students', 'Per-question breakdown', 'Student results access', 'Full override control', 'Export to Excel'], cta: 'Start Pro free', featured: true },
              { tier: 'Department', price: 'UGX 100,000', desc: 'For HODs and departments.', feats: ['Up to 5 lecturers', 'Everything in Pro', 'Admin dashboard', 'Priority support', 'Onboarding session'], cta: 'Contact us', featured: false },
            ].map(p => (
              <div key={p.tier} className={`plan-card ${p.featured ? 'featured' : ''}`}>
                {p.featured && <div className="pop-tag">Most popular</div>}
                <div className="plan-tier">{p.tier}</div>
                <div className="plan-price">{p.price} <span className="plan-period">/ month</span></div>
                <div className="plan-desc">{p.desc}</div>
                <ul className="plan-feats">
                  {p.feats.map(f => <li key={f} className="plan-feat"><span className="feat-check">✓</span>{f}</li>)}
                </ul>
                <button className="plan-btn" onClick={() => p.tier === 'Department' ? window.location.href = 'mailto:hello@markiq.app' : navigate('/signup')}>{p.cta}</button>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="final-section">
        <div className="final-orb" style={{ width: 500, height: 500, background: 'rgba(127,119,221,0.2)', top: -200, left: -100 }}></div>
        <div className="final-orb" style={{ width: 400, height: 400, background: 'rgba(206,203,246,0.15)', bottom: -150, right: -50 }}></div>
        <div className="final-inner">
          <div className="final-icon">⚡</div>
          <div className="final-title">First 50 lecturers get Pro free for 3 months</div>
          <p className="final-sub">No credit card. No commitment. Just faster marking starting today.</p>
          <button className="final-btn" onClick={() => navigate('/signup')}>Claim your free spot →</button>
          <div className="final-note">Only 13 spots remaining</div>
        </div>
      </div>

      {/* FOOTER */}
      <footer className="footer">
        <div className="foot-logo">Mark<span>IQ</span></div>
        <div className="foot-copy">Built for African universities. Powered by AI.</div>
        <div className="foot-links">
          <span className="foot-link">Privacy</span>
          <span className="foot-link">Terms</span>
          <span className="foot-link" onClick={() => window.location.href = 'mailto:hello@markiq.app'}>Contact</span>
        </div>
      </footer>
    </div>
  );
